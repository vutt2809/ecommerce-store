...
<head>
    ...
    <title>Ecommerce Seller - Login</title>
					...
					<div class="col-lg-4 col-md-5 col-12">
						...
						<div class="p-30 rounded30 box-shadowed b-2 b-dashed">
							...
							<div class="text-center">
								<p class="mt-15 mb-0 text-dark">Don't have an account? <a href="{{ route('seller.register') }}" class="text-info ml-5">Sign Up</a></p>
							</div>
						</div>
					</div>
				</div>
